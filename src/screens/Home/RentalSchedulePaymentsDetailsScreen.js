            ...
            <View style={styles.container}>
              ...
              <Card containerStyle={styles.detailsCard}>
                ...
                <View style={styles.detailsTextView}>
                    ...
                    <Text h4Style={styles.detailsText} h4>{paymentDetails.amount}</Text>
                </View>
                <View style={styles.detailsTextView}>
                    <Text h4Style={styles.detailsText} h4>Payment Date:</Text>
                    <Text h4Style={styles.detailsText} h4>{paymentDetails.date_created}</Text>
                </View>
                <View style={styles.detailsTextView}>
                    <Text h4Style={styles.detailsText} h4>Status: </Text>
                    <Text h4Style={styles.detailsText} h4>{paymentDetails}</Text>
                </View>
             </Card>
            </View>
        </ScrollView>  
...
export default RentalSchedulePaymentsDetailsScreen;